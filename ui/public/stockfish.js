  ...
  return (
    function(Stockfish) {
      ...
      A.postCustomMessage = a => {
        for (let b of B.Sa) b.postMessage({cmd: "custom", userData: a})
      };
      ...
      class ja {
        ...
        put(a) {
          this.Ya ? (this.Ya(a), this.Ya = null) : this.Ta.push(a)
        }
      }
      ...
      A.print = A.printErr = a => {
        if (0 === ka.length) console.log(a); else for (let b of ka) b(a)
      };
      A.terminate = () => {
        B.bc()
      };
      var la = {}, C;
      for (C in A) A.hasOwnProperty(C) && (la[C] = A[C]);
      var ma = [], na = "./this.program";

      function oa(a, b) {
        throw b;
      }

      var pa = "object" === typeof window, E = "function" === typeof importScripts,
        F = "object" === typeof process && "object" === typeof process.versions && "string" === typeof process.versions.node,
        G = A.ENVIRONMENT_IS_PTHREAD || !1, H = "";
      ...
      if (F) {
        ...
        process.on("uncaughtException",
          function(a) {
            if (!(a instanceof ua)) throw a;
          });
        process.on("unhandledRejection", M);
        oa = function(a, b) {
          if (va()) throw process.exitCode = a, b;
          process.exit(a)
        };
        A.inspect = function() {
      ...
      } else if (pa || E) E ? H = self.location.href : "undefined" !== typeof document && document.currentScript &&
        (H = document.currentScript.src), _scriptDir && (H = _scriptDir), 0 !== H.indexOf("blob:") ? H = H.substr(0, H.lastIndexOf("/") + 1) : H = "", F ? (ra = function(a, b) {
        K || (K = require("fs"));
        L || (L = require("path"));
        a = L.normalize(a);
        return K.readFileSync(a, b ? null : "utf8")
      ...
      var xa = A.print || console.log.bind(console), N = A.printErr || console.warn.bind(console);
      for (C in la) la.hasOwnProperty(C) && (A[C] = la[C]);
      la = null;
      ...
      if (G) h = A.wasmMemory, m = A.buffer; else if (A.wasmMemory) h = A.wasmMemory; else if (h = new WebAssembly.Memory({
        initial: Ma / 65536,
        maximum: 32768,
        shared: !0
      ...
      function Sa() {
        G || (A.noFSInit || P.nb.Rb || P.nb(), P.xc = !1, Ta(Oa))
      }
      ...
      function ab() {
        var a = Q;
        try {
          if (a == Q && za) return new Uint8Array(za);
          if (ta) return ta(a);
      ...
      function db(a, b) {
        if (0 >= a || a > e().length || a & 1 || 0 > b) return -28;
        if (0 == b) return 0;
        2147483647 <= b && (b = Infinity);
        var c = Atomics.load(w(), eb >> 2), d = 0;
        if (c == a && Atomics.compareExchange(w(), eb >> 2, c, 0) == c && (--b, d = 1, 0 >= b)) return 1;
      ...
      function fb(a) {
        if (G) throw"Internal Error! cleanupThread() can only ever be called from main application thread!";
        if (!a) throw"Internal Error! Null pthread_ptr in cleanupThread!";
        var b = B.Ja[a];
        b && (w()[a + 12 >> 2] = 0, B.Bb(b.worker))
      }

      var B = {
        Wa: [], Sa: [], dc: [], Zd: function() {
        }, ed: function() {
          for (var a = U(228), b = 0; 57 > b; ++b) x()[a / 4 + b] = 0;
          w()[a + 12 >> 2] = a;
          b = a + 152;
          w()[b >> 2] = b;
          var c = U(512);
          for (b = 0; 128 > b; ++b) x()[c / 4 + b] = 0;
          ...
          var b = jb();
          b && (B.Cc(b, a), G && postMessage({cmd: "exit"}))
        }, Fd: function() {
          B.Cc(jb(), -1);
          ...
          B.Wa = [];
          for (a = 0; a < B.Sa.length; ++a) c = B.Sa[a], b = c.Ia, B.Mb(b), c.terminate();
          B.Sa = []
        }, Mb: function(a) {
          if (a) {
            if (a.Pa) {
          ...
          a.onmessage = function(c) {
            ...
            if (d.targetThread && d.targetThread != jb()) {
              var g = B.Ja[d.ke];
              g ? g.worker.postMessage(c.data,
                d.transferList) : N('Internal error! Worker sent a message "' + f + '" to target pthread ' + d.targetThread + ", but that thread no longer exists!")
            } else if ("processQueuedMainThreadWork" === f) mb(); else if ("spawnThread" === f) nb(c.data); else if ("cleanupThread" === f) fb(d.thread); else if ("killThread" === f) {
              c = d.thread;
              if (G) throw"Internal Error! killThread() can only ever be called from main application thread!";
              ...
              c = d.thread;
              if (G) throw"Internal Error! cancelThread() can only ever be called from main application thread!";
              if (!c) throw"Internal Error! Null pthread_ptr in cancelThread!";
              B.Ja[c].worker.postMessage({cmd: "cancel"})
            } else if ("loaded" === f) a.loaded = !0, b && b(a), a.rb && (a.rb(), delete a.rb); else if ("print" === f) xa("Thread " + d.threadId + ": " + d.text); else if ("printErr" === f) N("Thread " + d.threadId + ": " + d.text); else if ("alert" ===
              f) alert("Thread " + d.threadId + ": " + d.text); else if ("exit" === f) a.Ia && Atomics.load(x(), a.Ia.Pa + 64 >> 2) && B.Bb(a); else if ("exitProcess" === f) try {
              ob(d.returnCode)
            } catch (k) {
              if (k instanceof ua) return;
              throw k;
            } else "cancelDone" === f ? B.Bb(a) : "objectTransfer" !== f && ("setimmediate" === c.data.target ? a.postMessage(c.data) : N("worker sent an unknown command " + f));
            B.Xc = void 0
          };
          ...
          a.postMessage({cmd: "load", urlOrBlob: A.mainScriptUrlOrBlob || _scriptDir, wasmMemory: h, wasmModule: Aa})
        }, Mc: function() {
          var a = qa("stockfish.worker.js");
          B.Wa.push(new Worker(a))
        }, cd: function() {
          0 == B.Wa.length && (B.Mc(), B.ld(B.Wa[0]));
          return B.Wa.pop()
        }, Od: function(a) {
      ...
      function nb(a) {
        if (G) throw"Internal Error! spawnThread() can only ever be called from main application thread!";
        var b = B.cd();
        if (!b) return 6;
        if (void 0 !== b.Ia) throw"Internal error!";
        if (!a.Ab) throw"Internal error, no pthread ptr!";
        B.Sa.push(b);
        for (var c = U(512), d = 0; 128 > d; ++d) w()[c + 4 * d >> 2] = 0;
        var f = a.cb + a.ib;
        d = B.Ja[a.Ab] = {worker: b, cb: a.cb, ib: a.ib, Ib: a.Ib, Pa: a.Ab};
        var g = d.Pa >> 2;
        ...
        b.Ia = d;
        var k = {cmd: "run", start_routine: a.Dd, arg: a.mb, threadInfoStruct: a.Ab, stackBase: a.cb, stackSize: a.ib};
        b.rb = function() {
          k.time = performance.now();
          b.postMessage(k, a.Ld)
        };
        b.loaded && (b.rb(), delete b.rb);
        return 0
      }

      function ub(a, b, c) {
        if (0 >= a || a > e().length || a & 1) return -28;
        if (pa) {
      ...
      function vb() {
        F || E || (ya || (ya = {}), ya["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] || (ya["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] = 1, N("Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread")))
      }

      function wb(a, b) {
        if (!a) return N("pthread_join attempted on a null thread pointer!"), 71;
        if (G && jb() == a) return N("PThread " + a + " is attempting to join to itself!"), 16;
        if (!G && xb() == a) return N("Main thread " + a + " is attempting to join to itself!"), 16;
        if (w()[a + 12 >> 2] !== a) return N("pthread_join attempted on thread " + a + ", which does not point to a valid thread, or does not exist anymore!"), 71;
        if (Atomics.load(x(), a + 64 >> 2)) return N("Attempted to join thread " + a + ", which was already detached!"), 28;
        for (vb(); ;) {
          var c =
            Atomics.load(x(), a + 0 >> 2);
          if (1 == c) return c = Atomics.load(x(), a + 4 >> 2), b && (w()[b >> 2] = c), Atomics.store(x(), a + 64 >> 2, 1), G ? postMessage({
            cmd: "cleanupThread",
            thread: a
          }) : fb(a), 0;
          yb();
      ...
      function Fb(a, b) {
        ...
        a = c(a.split("/"));
        b = c(b.split("/"));
        for (var d = Math.min(a.length, b.length), f = d, g = 0; g < d; g++) if (a[g] !== b[g]) {
          f = g;
          break
        }
        d = [];
      ...
      var Ib = {
        open: function(a) {
          ...
          if (!a.tty || !a.tty.hb.uc) throw new P.W(60);
          for (var f = 0, g = 0; g < d; g++) {
            ...
            if (void 0 === k && 0 === f) throw new P.W(6);
          ...
          if (!a.tty || !a.tty.hb.Yb) throw new P.W(60);
          try {
            for (var f = 0; f < d; f++) a.tty.hb.Yb(a.tty, b[c + f])
          } catch (g) {
            throw new P.W(29);
          }
        ...
        uc: function(a) {
          ...
          null === b || 10 === b ? (xa(Fa(a.output, 0)), a.output = []) : 0 != b && a.output.push(b)
        }, flush: function(a) {
          a.output && 0 < a.output.length && (xa(Fa(a.output, 0)), a.output = [])
        }
      }, Lb = {
        Yb: function(a, b) {
          null === b || 10 === b ? (N(Fa(a.output, 0)), a.output = []) : 0 != b && a.output.push(b)
        }, flush: function(a) {
          a.output && 0 < a.output.length && (N(Fa(a.output, 0)), a.output = [])
        }
      };
      ...
      var W = {
        Oa: null, Ca: function() {
          ...
          if (P.hd(c) || P.isFIFO(c)) throw new P.W(63);
          W.Oa || (W.Oa = {
            dir: {
              node: {
                La: W.xa.La,
            ...
            file: {
              node: {La: W.xa.La, Ga: W.xa.Ga},
              stream: {Ma: W.za.Ma, read: W.za.read, write: W.za.write, lb: W.za.lb, fb: W.za.fb, gb: W.za.gb}
            },
            link: {
              node: {La: W.xa.La, Ga: W.xa.Ga, readlink: W.xa.readlink},
              stream: {}
            },
            ic: {node: {La: W.xa.La, Ga: W.xa.Ga}, stream: P.Pc}
          });
          c = P.createNode(a, b, c, d);
          P.Da(c.mode) ? (c.xa = W.Oa.dir.node, c.za = W.Oa.dir.stream, c.ya = {}) : P.isFile(c.mode) ? (c.xa = W.Oa.file.node, c.za = W.Oa.file.stream, c.Ba = 0, c.ya = null) : P.eb(c.mode) ? (c.xa = W.Oa.link.node, c.za = W.Oa.link.stream) : P.wb(c.mode) && (c.xa = W.Oa.ic.node, c.za = W.Oa.ic.stream);
          c.timestamp = Date.now();
          a && (a.ya[b] = c, a.timestamp = c.timestamp);
          return c
        }, Xd: function(a) {
        ...
        oc: function(a, b) {
          ...
          c >= b || (b = Math.max(b, c * (1048576 > c ? 2 : 1.125) >>> 0), 0 != c && (b = Math.max(b, 256)), c = a.ya, a.ya = new Uint8Array(b), 0 < a.Ba && a.ya.set(c.subarray(0, a.Ba), 0))
        }, zd: function(a, b) {
          if (a.Ba != b) if (0 == b) a.ya = null, a.Ba = 0; else {
            var c = a.ya;
          ...
          La: function(a) {
            ...
            b.gid = 0;
            b.rdev = a.rdev;
            P.Da(a.mode) ? b.size = 4096 : P.isFile(a.mode) ? b.size = a.Ba :
              P.eb(a.mode) ? b.size = a.link.length : b.size = 0;
            ...
            if (P.Da(a.mode)) {
              ...
              if (d) for (var f in d.ya) throw new P.W(55);
            }
            ...
            var c = P.Qa(a, b), d;
            for (d in c.ya) throw new P.W(55);
            delete a.ya[b];
            a.timestamp = Date.now()
          }, readdir: function(a) {
            var b = [".", ".."], c;
            for (c in a.ya) a.ya.hasOwnProperty(c) && b.push(c);
            return b
            ...
            if (!P.eb(a.mode)) throw new P.W(28);
            return a.link
          }
        }, za: {
          read: function(a, b, c, d, f) {
            var g = a.node.ya;
            if (f >= a.node.Ba) return 0;
            ...
            if (b.subarray && (!a.ya || a.ya.subarray)) {
              if (g) return a.ya = b.subarray(c, c + d), a.Ba = d;
              if (0 === a.Ba && 0 === f) return a.ya = b.slice(c, c + d), a.Ba = d;
              if (f + d <= a.Ba) return a.ya.set(b.subarray(c, c + d), f), d
            }
            W.oc(a,
              f + d);
            if (a.ya.subarray && b.subarray) a.ya.set(b.subarray(c, c + d), f); else for (g = 0; g < d; g++) a.ya[f + g] = b[c + g];
            a.Ba = Math.max(a.Ba, f + d);
            return d
          }, Ma: function(a, b, c) {
            1 === c ? b += a.position : 2 === c && P.isFile(a.node.mode) && (b += a.node.Ba);
            if (0 > b) throw new P.W(28);
            return b
          }, lb: function(a, b, c) {
            W.oc(a.node, b + c);
            ...
            if (0 !== b) throw new P.W(28);
            if (!P.isFile(a.node.mode)) throw new P.W(43);
            a = a.node.ya;
            if (g & 2 || a.buffer !== m) {
      ...
      function Ob(a, b, c) {
        ...
        sa(a, function(f) {
          ...
          if (c) c(); else throw'Loading data file "' + a + '" failed.';
        });
        d && Ya()
      }
      ...
      var P = {
        ...
        Aa: function(a, b) {
          ...
          for (d = 0; d < a.length; d++) {
            ...
            if (!g || b.Ka) for (g =
                                   0; P.eb(f.mode);) if (f = P.readlink(c), c = Eb(Bb(c), f), f = P.Aa(c, {$b: b.$b}).node, 40 < g++) throw new P.W(32);
          }
          return {path: c, node: f}
        },
        Va: function(a) {
          for (var b; ;) {
            if (P.xb(a)) return a = a.Ca.yc, b ? "/" !== a[a.length - 1] ? a + "/" + b : a + b : a;
            b = b ? a.name + "/" + b : a.name;
            a = a.parent
          }
        },
        ...
        ad: {r: 0, "r+": 2, w: 577, "w+": 578, a: 1089, "a+": 1090},
        qd: function(a) {
          var b = P.ad[a];
        ...
        bb: function(a, b) {
          ...
          if (!b.includes("r") || a.mode & 292) {
            if (b.includes("w") && !(a.mode & 146) || b.includes("x") &&
              !(a.mode & 73)) return 2
          } else return 2;
          return 0
        },
        ...
        yb: function(a, b, c) {
          ...
          if (a = P.bb(a, "wx")) return a;
          if (c) {
            if (!P.Da(d.mode)) return 54;
            if (P.xb(d) || P.Va(d) === P.cwd()) return 10
          } else if (P.Da(d.mode)) return 31;
          return 0
        },
        pd: function(a, b) {
        ...
        sd: function(a,
                     b) {
          b = b || P.Hc;
          for (a = a || 0; a <= b; a++) if (!P.streams[a]) return a;
          throw new P.W(33);
        },
        Xa: function(a) {
          return P.streams[a]
        ...
        Dc: function(a, b) {
          ...
          f.forEach(function(k) {
            if (!k.type.Dc) return d(null);
            k.type.Dc(k, a, d)
          })
        },
        Ca: function(a, b, c) {
          var d = "/" === c, f = !c;
          if (d && P.root) throw new P.W(10);
          if (!d && !f) {
            var g = P.Aa(c, {Lb: !1});
            c = g.path;
            g = g.node;
            if (P.Za(g)) throw new P.W(10);
            if (!P.Da(g.mode)) throw new P.W(54);
          }
          b = {type: a, fe: b, yc: c, qb: []};
          a = a.Ca(b);
          a.Ca = b;
          b.root = a;
          d ? P.root = a : g && (g.pb = b, g.Ca && g.Ca.qb.push(b));
          return a
        },
        ne: function(a) {
          a = P.Aa(a, {Lb: !1});
          if (!P.Za(a.node)) throw new P.W(28);
          a = a.node;
          var b = a.pb, c = P.tc(b);
        ...
        Ra: function(a, b, c) {
          var d = P.Aa(a, {parent: !0}).node;
          a = V(a);
          if (!a || "." === a || ".." === a) throw new P.W(28);
          var f = P.Xb(d, a);
          if (f) throw new P.W(f);
          if (!d.xa.Ra) throw new P.W(63);
        ...
        symlink: function(a, b) {
          if (!Eb(a)) throw new P.W(44);
          var c = P.Aa(b, {parent: !0}).node;
          if (!c) throw new P.W(44);
          b = V(b);
          var d = P.Xb(c, b);
          if (d) throw new P.W(d);
          if (!c.xa.symlink) throw new P.W(63);
          return c.xa.symlink(c, b, a)
        },
        rename: function(a, b) {
          var c = Bb(a), d = Bb(b), f = V(a), g = V(b);
          var k = P.Aa(a, {parent: !0});
          var p = k.node;
          k = P.Aa(b, {parent: !0});
          k = k.node;
          if (!p || !k) throw new P.W(44);
          if (p.Ca !== k.Ca) throw new P.W(75);
          var t = P.Qa(p, f);
          d = Fb(a, d);
          if ("." !== d.charAt(0)) throw new P.W(28);
          d = Fb(b, c);
          if ("." !== d.charAt(0)) throw new P.W(55);
          try {
            var n = P.Qa(k, g)
          } catch (r) {
          }
          if (t !== n) {
            c = P.Da(t.mode);
            if (f = P.yb(p, f, c)) throw new P.W(f);
            if (f = n ? P.yb(k, g, c) : P.Xb(k, g)) throw new P.W(f);
            if (!p.xa.rename) throw new P.W(63);
            if (P.Za(t) || n && P.Za(n)) throw new P.W(10);
            if (k !== p && (f = P.bb(p, "w"))) throw new P.W(f);
            try {
              P.Ea.willMovePath && P.Ea.willMovePath(a, b)
            } catch (r) {
              N("FS.trackingDelegate['willMovePath']('" +
                a + "', '" + b + "') threw an exception: " + r.message)
            }
            P.wc(t);
            try {
              p.xa.rename(t, k, g)
            ...
            try {
              if (P.Ea.onMovePath) P.Ea.onMovePath(a, b)
            } catch (r) {
        ...
        rmdir: function(a) {
          var b = P.Aa(a, {parent: !0}).node, c = V(a), d = P.Qa(b, c), f = P.yb(b, c, !0);
          if (f) throw new P.W(f);
          if (!b.xa.rmdir) throw new P.W(63);
          if (P.Za(d)) throw new P.W(10);
          try {
            P.Ea.willDeletePath && P.Ea.willDeletePath(a)
          } catch (g) {
            N("FS.trackingDelegate['willDeletePath']('" +
              a + "') threw an exception: " + g.message)
          }
          b.xa.rmdir(b, c);
          P.Kb(d);
          try {
            if (P.Ea.onDeletePath) P.Ea.onDeletePath(a)
          } catch (g) {
        ...
        readdir: function(a) {
          a = P.Aa(a, {Ka: !0}).node;
          if (!a.xa.readdir) throw new P.W(54);
          return a.xa.readdir(a)
        },
        unlink: function(a) {
          var b = P.Aa(a, {parent: !0}).node, c = V(a), d = P.Qa(b, c), f = P.yb(b, c, !1);
          if (f) throw new P.W(f);
          if (!b.xa.unlink) throw new P.W(63);
          if (P.Za(d)) throw new P.W(10);
          try {
            P.Ea.willDeletePath && P.Ea.willDeletePath(a)
          } catch (g) {
        ...
        readlink: function(a) {
          a = P.Aa(a).node;
          if (!a) throw new P.W(44);
          if (!a.xa.readlink) throw new P.W(28);
          return Eb(P.Va(a.parent), a.xa.readlink(a))
        },
        stat: function(a, b) {
          a = P.Aa(a, {Ka: !b}).node;
          if (!a) throw new P.W(44);
          if (!a.xa.La) throw new P.W(63);
          return a.xa.La(a)
        },
        lstat: function(a) {
          return P.stat(a, !0)
        ...
        chmod: function(a,
                        b, c) {
          a = "string" === typeof a ? P.Aa(a, {Ka: !c}).node : a;
          if (!a.xa.Ga) throw new P.W(63);
          a.xa.Ga(a, {mode: b & 4095 | a.mode & -4096, timestamp: Date.now()})
        },
        lchmod: function(a, b) {
          P.chmod(a, b, !0)
        },
        fchmod: function(a, b) {
          a = P.Xa(a);
          if (!a) throw new P.W(8);
          P.chmod(a.node, b)
        },
        chown: function(a, b, c, d) {
          a = "string" === typeof a ? P.Aa(a, {Ka: !d}).node : a;
          if (!a.xa.Ga) throw new P.W(63);
          a.xa.Ga(a, {timestamp: Date.now()})
        },
        ...
        truncate: function(a, b) {
          if (0 > b) throw new P.W(28);
          a = "string" === typeof a ? P.Aa(a, {Ka: !0}).node : a;
          if (!a.xa.Ga) throw new P.W(63);
          if (P.Da(a.mode)) throw new P.W(31);
          if (!P.isFile(a.mode)) throw new P.W(28);
          var c = P.bb(a, "w");
          if (c) throw new P.W(c);
          a.xa.Ga(a, {size: b, timestamp: Date.now()})
        },
        Wd: function(a, b) {
          a = P.Xa(a);
          if (!a) throw new P.W(8);
          if (0 === (a.flags & 2097155)) throw new P.W(28);
          P.truncate(a.node, b)
        },
        oe: function(a, b, c) {
          a = P.Aa(a, {Ka: !0}).node;
          a.xa.Ga(a, {timestamp: Math.max(b, c)})
        },
        open: function(a, b, c, d, f) {
          ...
          if ("object" === typeof a) var g = a; else {
            a = Ab(a);
            try {
              g = P.Aa(a, {Ka: !(b & 131072)}).node
            } catch (p) {
            }
          }
          var k = !1;
          if (b & 64) if (g) {
            if (b & 128) throw new P.W(20);
          } else g = P.Ra(a, c, 0), k = !0;
          if (!g) throw new P.W(44);
          P.wb(g.mode) && (b &= -513);
          if (b & 65536 && !P.Da(g.mode)) throw new P.W(54);
          if (!k && (c = P.pd(g, b))) throw new P.W(c);
          b & 512 && P.truncate(g, 0);
          b &= -131713;
          d = P.Wc({
            node: g, path: P.Va(g), flags: b, seekable: !0, position: 0, za: g.za, Md: [],
            error: !1
          }, d, f);
          d.za.open && d.za.open(d);
          !A.logReadFiles || b & 1 || (P.Zb || (P.Zb = {}), a in P.Zb || (P.Zb[a] = 1, N("FS.trackingDelegate error on read file: " + a)));
          try {
            P.Ea.onOpenFile && (f = 0, 1 !== (b & 2097155) && (f |= P.Fc.Ac.Ic), 0 !== (b & 2097155) && (f |= P.Fc.Ac.Jc), P.Ea.onOpenFile(a, f))
          } catch (p) {
        ...
        Ma: function(a, b, c) {
          if (P.ob(a)) throw new P.W(8);
          if (!a.seekable || !a.za.Ma) throw new P.W(70);
          if (0 != c && 1 != c && 2 != c) throw new P.W(28);
          a.position = a.za.Ma(a, b, c);
          a.Md = [];
          return a.position
        },
        read: function(a, b, c, d, f) {
          if (0 > d || 0 > f) throw new P.W(28);
          if (P.ob(a)) throw new P.W(8);
          if (1 === (a.flags & 2097155)) throw new P.W(8);
          if (P.Da(a.node.mode)) throw new P.W(31);
          if (!a.za.read) throw new P.W(28);
          var g = "undefined" !== typeof f;
          if (!g) f = a.position; else if (!a.seekable) throw new P.W(70);
        ...
        write: function(a, b, c, d, f, g) {
          if (0 > d || 0 > f) throw new P.W(28);
          if (P.ob(a)) throw new P.W(8);
          if (0 === (a.flags & 2097155)) throw new P.W(8);
          if (P.Da(a.node.mode)) throw new P.W(31);
          if (!a.za.write) throw new P.W(28);
          a.seekable && a.flags & 1024 && P.Ma(a, 0, 2);
          var k = "undefined" !== typeof f;
          if (!k) f = a.position; else if (!a.seekable) throw new P.W(70);
          b = a.za.write(a, b, c, d, f, g);
          k || (a.position += b);
          try {
            if (a.path && P.Ea.onWriteToFile) P.Ea.onWriteToFile(a.path)
          } catch (p) {
            N("FS.trackingDelegate['onWriteToFile']('" +
              a.path + "') threw an exception: " + p.message)
          }
          return b
        },
        lb: function(a, b, c) {
          if (P.ob(a)) throw new P.W(8);
          if (0 > b || 0 >= c) throw new P.W(28);
          if (0 === (a.flags & 2097155)) throw new P.W(8);
          if (!P.isFile(a.node.mode) && !P.Da(a.node.mode)) throw new P.W(43);
          if (!a.za.lb) throw new P.W(138);
          a.za.lb(a, b, c)
        },
        fb: function(a, b, c, d, f, g) {
          if (0 !== (f & 2) && 0 === (g & 2) && 2 !== (a.flags & 2097155)) throw new P.W(2);
          if (1 === (a.flags & 2097155)) throw new P.W(2);
          if (!a.za.fb) throw new P.W(43);
          return a.za.fb(a, b, c, d, f, g)
        },
        gb: function(a, b, c, d, f) {
          return a &&
          a.za.gb ? a.za.gb(a, b, c, d, f) : 0
        },
        ee: function() {
          return 0
        },
        Sb: function(a, b, c) {
          if (!a.za.Sb) throw new P.W(59);
        ...
        writeFile: function(a, b, c) {
          ...
          } else if (ArrayBuffer.isView(b)) P.write(a, b, 0, b.byteLength, void 0, c.Oc); else throw Error("Unsupported data type");
          P.close(a)
        },
        cwd: function() {
          return P.kc
        ...
        chdir: function(a) {
          a = P.Aa(a, {Ka: !0});
          if (null === a.node) throw new P.W(44);
          if (!P.Da(a.node.mode)) throw new P.W(54);
          var b = P.bb(a.node, "x");
          if (b) throw new P.W(b);
          P.kc = a.path
        },
        Sc: function() {
          P.mkdir("/tmp");
        ...
        Uc: function() {
          ...
          P.Ca({
            Ca: function() {
              var b = P.createNode(a, "fd",
                16895, 73);
              b.xa = {
                lookup: function(c, d) {
                  var f = P.Xa(+d);
                  if (!f) throw new P.W(8);
                  c = {
                    parent: null, Ca: {yc: "fake"}, xa: {
                      readlink: function() {
                        return f.path
                      }
                    }
        ...
        nc: function() {
          ...
          }, P.W.prototype = Error(), P.W.prototype.constructor = P.W, [44].forEach(function(a) {
            P.Nb[a] = new P.W(a);
        ...
        Jb: function(a, b) {
          ...
          var d = {xb: !1, exists: !1, error: 0, name: null, path: null, object: null, td: !1, vd: null, ud: null};
          try {
            c = P.Aa(a, {parent: !0}), d.td = !0, d.vd = c.path, d.ud = c.node, d.name = V(a), c = P.Aa(a, {Ka: !b}), d.exists = !0, d.path = c.path, d.object = c.node, d.name = c.node.name, d.xb = "/" === c.path
          } catch (f) {
            d.error =
              f.Fa
          }
          ...
          P.ac(f, {
            open: function(g) {
              ...
              for (var n = 0, r = 0; r < t; r++) {
                ...
                if (void 0 === z && 0 === n) throw new P.W(6);
        ...
        qc: function(a) {
          if (a.Tb || a.jd || a.link || a.ya) return !0;
          ...
          if (ra) try {
            a.ya = Jb(ra(a.url), !0), a.Ba = a.ya.length
          } catch (b) {
            throw new P.W(29);
        ...
        Rd: function(a, b, c, d, f) {
          ...
          g.prototype.hc = function() {
            ...
            n.open("HEAD", c, !1);
            n.send(null);
            if (!(200 <= n.status && 300 > n.status || 304 === n.status)) throw Error("Couldn't load " + c + ". Status: " + n.status);
            var r = Number(n.getResponseHeader("Content-length")),
              z, D = (z = n.getResponseHeader("Accept-Ranges")) && "bytes" === z;
            ...
            u.Nd(function(y) {
              ...
              if ("undefined" === typeof u.Ta[y]) {
                var Rc = u.Ta;
                if (I > S) throw Error("invalid range (" + I + ", " + S + ") or no bytes requested!");
                if (S > r - 1) throw Error("only " + r + " bytes available! programmer error!");
                var J = new XMLHttpRequest;
                J.open("GET", c, !1);
                r !== l && J.setRequestHeader("Range", "bytes=" + I + "-" + S);
                "undefined" !=
                typeof Uint8Array && (J.responseType = "arraybuffer");
              ...
              if ("undefined" === typeof u.Ta[y]) throw Error("doXHR failed!");
              return u.Ta[y]
            });
            if (n || !r) l = r = 1, l = r = this.Ya(0).length, xa("LazyFiles on gzip forces download of the whole file when length is accessed");
            this.Lc = r;
            this.Kc = l;
            this.Ub = !0
          };
          ...
          k.ya ? p.ya = k.ya : k.url && (p.ya = null, p.url = k.url);
          ...
          t.read = function(n, r, z, D, l) {
            ...
            if (n.slice) for (var u = 0; u < D; u++) r[z + u] = n[l + u]; else for (u = 0; u < D; u++) r[z + u] = n.get(l + u);
            return D
          };
          p.za = t;
          return p
        ...
        je: function(a, b, c) {
          ...
          f.onsuccess = function() {
            var g = f.result.transaction([P.kb], "readwrite"), k = g.objectStore(P.kb), p = 0, t = 0, n = a.length;
        ...
        $d: function(a, b, c) {
          ...
          f.onsuccess = function() {
            var g = f.result;
            try {
              var k = g.transaction([P.kb],
                "readonly")
            } catch (z) {
              c(z);
              return
            }
            var p = k.objectStore(P.kb), t = 0, n = 0, r = a.length;
      ...
      function Rb(a, b) {
        ...
        try {
          ...
          if (f && f.node && Ab(a) !== Ab(P.Va(f.node))) return -54;
          throw f;
        }
        w()[b >> 2] = d.dev;
        w()[b + 4 >> 2] = 0;
        ...
        w()[b + 28 >> 2] = d.rdev;
        w()[b + 32 >> 2] = 0;
        T = [d.size >>> 0, (R = d.size, 1 <= +Math.abs(R) ? 0 < R ? (Math.min(+Math.floor(R / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((R - +(~~R >>> 0)) / 4294967296) >>> 0 : 0)];
        w()[b + 40 >> 2] = T[0];
        w()[b + 44 >> 2] = T[1];
        w()[b + 48 >> 2] = 4096;
        w()[b + 52 >> 2] = d.blocks;
        w()[b +
        56 >> 2] = d.atime.getTime() / 1E3 | 0;
        w()[b + 60 >> 2] = 0;
        w()[b + 64 >> 2] = d.mtime.getTime() / 1E3 | 0;
        w()[b + 68 >> 2] = 0;
        w()[b + 72 >> 2] = d.ctime.getTime() / 1E3 | 0;
        w()[b + 76 >> 2] = 0;
        T = [d.ino >>> 0, (R = d.ino, 1 <= +Math.abs(R) ? 0 < R ? (Math.min(+Math.floor(R / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((R - +(~~R >>> 0)) / 4294967296) >>> 0 : 0)];
        w()[b + 80 >> 2] = T[0];
        w()[b + 84 >> 2] = T[1];
        return 0
      }
        ...
        try {
          ...
          switch (b) {
            ...
            case 3:
              return d.flags;
            case 4:
              return f = Tb(), d.flags |= f, 0;
            case 12:
              return f = Tb(), h.buffer != m && q(h.buffer), La[f + 0 >> 1] = 2, 0;
            case 13:
            case 14:
              return 0;
            case 16:
          ...
          return "undefined" !== typeof P && g instanceof P.W || M(g), -g.Fa
        }
      }

      function Wb(a, b) {
        if (G) return Y(3, 1, a, b);
        try {
          var c = X(a);
          return Rb(c.path, b)
        } catch (d) {
          return "undefined" !== typeof P && d instanceof P.W || M(d), -d.Fa
        }
      }

      function Xb(a, b, c) {
        if (G) return Y(4, 1, a, b, c);
        Sb = c;
        try {
          var d = X(a);
          switch (b) {
      ...
      function Yb(a, b, c, d, f, g) {
        if (G) return Y(5, 1, a, b, c, d, f, g);
        try {
          a:{
            g <<= 12;
            var k = !1;
            if (0 !== (d & 16) && 0 !== a % 65536) var p = -28; else {
              if (0 !== (d & 32)) {
                var t = Mb(b);
                if (!t) {
                  p = -48;
              ...
              Qb[t] = {nd: t, kd: b, Hb: k, fd: f, wd: c, flags: d, offset: g};
              p = t
            }
          }
          return p
        } catch (z) {
          return "undefined" !== typeof P && z instanceof P.W || M(z), -z.Fa
        }
      }

      function Zb(a, b) {
        if (G) return Y(6, 1, a, b);
        try {
          var c = Qb[a];
          if (0 !== b && c) {
            if (b === c.kd) {
              var d = P.Xa(c.fd);
              if (d && c.wd & 2) {
                var f = c.flags, g = c.offset, k = v().slice(a, a + b);
                P.gb(d, k, g, b, f)
              }
              Qb[a] = null;
              c.Hb && kb(c.nd)
          ...
          return "undefined" !== typeof P && t instanceof P.W || M(t), -t.Fa
        }
      }

      function $b(a, b, c) {
        if (G) return Y(7, 1, a, b, c);
        Sb = c;
        try {
          var d = O(a), f = c ? Tb() : 0;
      ...
      function ac(a, b) {
        if (G) return Y(8, 1, a, b);
        try {
          return a = O(a), Rb(a, b)
        } catch (c) {
          return "undefined" !== typeof P && c instanceof P.W || M(c), -c.Fa
        }
      }
      ...
      var gc = [], hc = [0, "undefined" !== typeof document ? document : 0, "undefined" !== typeof window ? window : 0];
      ...
      function jc(a, b, c) {
        var d = ic(a);
        if (!d) return -4;
        d.vb && (w()[d.vb >> 2] = b, w()[d.vb + 4 >> 2] = c);
        if (d.zc || !d.Qd) d.zc && (d = d.zc), a = !1, d.ub && d.ub.tb && (a = d.ub.tb.getParameter(2978), a = 0 === a[0] && 0 === a[1] && a[2] === d.width && a[3] === d.height), d.width = b, d.height = c, a && d.ub.tb.viewport(0, 0, b, c); else {
          if (d.vb) {
            d = w()[d.vb + 8 >> 2];
            a = a ? O(a) : "";
            var f = ec(), g = Ja(12), k = 0;
            if (a) {
              k = Ha(a) + 1;
              var p = U(k);
              Ga(a, v(), p, k);
      ...
      function mc(a) {
        if (!Ba) {
          try {
            ...
            if (b instanceof ua) return;
            if ("unwind" !== b) throw b && "object" === typeof b && b.stack && N("exception thrown: " + [b, b.stack]), b;
          }
          if (G && !va()) try {
            G ? nc(Ca) : ob(Ca)
          } catch (b) {
            if (!(b instanceof ua)) throw b;
          }
        }
      }
      ...
      function rc(a, b) {
        a.sc || (a.sc = a.getContext, a.getContext = function(d, f) {
          f = a.sc(d, f);
      ...
      function sc(a, b) {
        var c = U(8);
        w()[c + 4 >> 2] = jb();
        var d = {Yd: c, attributes: b, version: b.md, tb: a};
      ...
      function Cc(a, b) {
        if (G) return Y(15, 1, a, b);
        try {
          var c = X(a), d = c.tty ? 2 : P.Da(c.mode) ? 3 : P.eb(c.mode) ? 7 : 4;
          e()[b >> 0] = d;
          return 0
        } catch (f) {
          return "undefined" !== typeof P && f instanceof P.W || M(f), f.Fa
        }
      }
        ...
        try {
          a:{
            for (var f = X(a), g = a = 0; g < c; g++) {
              var k = w()[b + 8 * g >> 2], p = w()[b + (8 * g + 4) >> 2], t = P.read(f, e(), k, p, void 0);
              if (0 > t) {
                var n = -1;
                break a
              }
          ...
          return "undefined" !== typeof P && r instanceof P.W || M(r), r.Fa
        }
      }

      function Ec(a, b, c, d, f) {
        if (G) return Y(17, 1, a, b, c, d, f);
        try {
          var g = X(a);
          a = 4294967296 * c + (b >>> 0);
          if (-9007199254740992 >= a || 9007199254740992 <= a) return -61;
          P.Ma(g, a, d);
          T = [g.position >>> 0, (R = g.position, 1 <= +Math.abs(R) ? 0 < R ? (Math.min(+Math.floor(R / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((R - +(~~R >>> 0)) / 4294967296) >>> 0 : 0)];
          w()[f >> 2] = T[0];
          w()[f + 4 >> 2] = T[1];
          g.Pb && 0 === a && 0 === d && (g.Pb = null);
          return 0
        } catch (k) {
          return "undefined" !== typeof P && k instanceof P.W || M(k), k.Fa
        }
      }
      ...
      function Fc(a, b, c, d) {
        ...
        try {
          a:{
            for (var f = X(a), g = a = 0; g < c; g++) {
              var k = w()[b + 8 * g >> 2], p = w()[b + (8 * g + 4) >> 2], t = P.write(f, e(), k, p, void 0);
              if (0 > t) {
                var n = -1;
                break a
              }
      ...
      function Kc(a, b) {
        for (a = new Date(a.getTime()); 0 < b;) {
          var c = a.getMonth(), d = (Gc(a.getFullYear()) ? Ic : Jc)[c];
      ...
      function Lc(a, b, c, d) {
        function f(l, u, y) {
          for (l = "number" === typeof l ? l.toString() : l || ""; l.length < u;) l = y[0] + l;
          return l
        }
        ...
        function t(l) {
          ...
          var u = new Date(l.getFullYear() + 1, 0, 4), y = p(new Date(l.getFullYear(), 0, 4));
          u = p(u);
        ...
        n = {
          "%a": function(l) {
            ...
            var u = new Date(l.Ha + 1900, 0, 1), y = 0 === u.getDay() ? u : Kc(u, 7 - u.getDay());
            l = new Date(l.Ha + 1900, l.jb, l.sb);
            return 0 >
            k(y, l) ? g(Math.ceil((31 - y.getDate() + (Hc(Gc(l.getFullYear()) ? Ic : Jc, l.getMonth() - 1) - 31) + l.getDate()) / 7), 2) : 0 === k(y, u) ? "01" : "00"
          }, "%V": function(l) {
            var u = new Date(l.Ha + 1901, 0, 4), y = p(new Date(l.Ha + 1900, 0, 4));
            u = p(u);
            ...
            var u = new Date(l.Ha, 0, 1), y = 1 === u.getDay() ? u : Kc(u, 0 === u.getDay() ? 1 : 7 - u.getDay() + 1);
            l =
              new Date(l.Ha + 1900, l.jb, l.sb);
      ...
      var Z = 0, Nc = null, Oc = 0, Pc = [], Qc = {}, Sc = {}, Tc = 0, Uc = null, Vc = [], Wc = [];

      function Xc(a) {
        var b = {}, c;
        for (c in a) (function(d) {
          var f = a[d];
          b[d] = "function" === typeof f ? function() {
            ...
            try {
              ...
              if (!Ba) {
                var g = Pc.pop();
                assert(g === d);
                Nc && 1 === Z && 0 === Pc.length && (Ra += 1, Z = 0, Mc(A._asyncify_stop_unwind), "undefined" !== typeof Fibers && Fibers.me(), Uc && (Uc(), Uc = null))
              }
            }
          } : f
        })(c);
          ...
          if (0 === Z) {
            ...
            a(function(d) {
              if (!Ba && (Oc = d || 0, b = !0, c)) {
                ...
                var f = Zc();
                Nc || (d = Vc, Vc = [], d.forEach(function(g) {
                  g(f)
                }))
              }
            });
            c = !0;
            b || (Z = 1, Nc = Yc(), Mc(function() {
              A._asyncify_start_unwind(Nc)
            }), "undefined" !== typeof Pb && Pb.Vb.rc && Pb.Vb.pause())
          } else 2 === Z ? (Z = 0, Mc(A._asyncify_stop_rewind), kb(Nc), Nc = null, Wc.forEach(function(d) {
            mc(d)
          })) : M("invalid state: " + Z);
          return Oc
        }
      ...
      var fd = {
        c: function(a, b, c, d) {
          ...
          if ("undefined" === typeof SharedArrayBuffer) return N("Current environment does not support SharedArrayBuffer, pthreads are not available!"), 6;
          if (!a) return N("pthread_create called with a null thread pointer!"), 28;
          var f = [];
          if (G && 0 === f.length) return ed(687865856, a, b, c,
            d);
          var g = 0, k = 0;
          if (b && -1 != b) {
            var p = w()[b >> 2];
          ...
          (b = 0 == g) ? g = Nb(16, p) : (g -= p, assert(0 < g));
          for (var t = U(228), n = 0; 57 > n; ++n) x()[(t >> 2) + n] = 0;
          w()[a >> 2] = t;
          w()[t + 12 >> 2] = t;
          a = t + 152;
          w()[a >> 2] = a;
          c = {cb: g, ib: p, Ib: b, detached: k, Dd: c, Ab: t, mb: d, Ld: f};
          return G ? (c.Pd = "spawnThread", postMessage(c, f), 0) : nb(c)
        }, M: function(a) {
          G ? B.Ec(a) : (B.Bc(), ob(a));
          throw"unwind";
        }, N: function(a, b) {
          return wb(a, b)
        }, j: Ub, F: Wb, w: Xb, B: function() {
          N("warning: unsupported syscall: __sys_madvise1");
          return 0
        }, D: Yb, C: Zb, k: $b, E: ac, R: function(a, b) {
          if (a == b) postMessage({cmd: "processQueuedMainThreadWork"}); else if (G) postMessage({
            targetThread: a,
          ...
          if (0 === a) a = Date.now(); else if (1 === a || 4 === a) a = sb(); else return w()[Vb() >> 2] = 28, -1;
          w()[b >> 2] = a / 1E3 | 0;
          w()[b + 4 >> 2] = a % 1E3 * 1E6 | 0;
          return 0
        }, m: function(a, b, c) {
          cc.length = 0;
          var d;
          for (c >>= 2; d = v()[b++];) (d = 105 > d) && c & 1 && c++, cc.push(d ?
            ea()[c++ >> 1] : w()[c]), ++c;
          return cb[a].apply(null, cc)
        }, x: vb, i: function() {
        }, A: dc, d: ub, e: db, g: sb, o: function(a, b, c) {
          v().copyWithin(a, b, b + c)
        }, I: function(a, b, c) {
          gc.length = b;
          c >>= 3;
          for (var d = 0; d < b; d++) gc[d] = ea()[c + d];
        ...
        }, s: zc, t: Ac, f: function(a) {
          ob(a)
        }, h: Bc, z: Cc, v: Dc, n: Ec, u: Fc, P: function() {
          B.ed()
        }, a: h || A.wasmMemory, r: function(a, b, c, d) {
          return Lc(a, b, c, d)
        }
      };
      (function() {
        ...
        if (A.instantiateWasm) try {
          ...
          return N("Module.instantiateWasm callback failed with error: " + g), !1
        }
        (function() {
          return za || "function" !==
          typeof WebAssembly.instantiateStreaming || $a() || "function" !== typeof fetch ? c(b) : fetch(Q, {credentials: "same-origin"}).then(function(g) {
      ...
      var hb = A._emscripten_register_main_browser_thread_id = function() {
        ...
        return (mb = A._emscripten_main_thread_process_queued_calls =
      ...
      }, tb = A._emscripten_get_global_libc =
        function() {
      ...
      function jd(a) {
        function b() {
          if (!gd && (gd = !0, A.calledRun = !0, !Ba)) {
            Sa();
            G || Ta(Pa);
            ha(A);
            if (A.onRuntimeInitialized) A.onRuntimeInitialized();
            if (kd) {
              var c = a, d = A._emscripten_proxy_main;
              c = c || [];
              var f = c.length + 1, g = Ja(4 * (f + 1));
              w()[g >> 2] = Ia(na);
              for (var k = 1; k < f; k++) w()[(g >> 2) + k] = Ia(c[k - 1]);
              w()[(g >> 2) + f] = 0;
              d(f, g)
            }
            if (!G) {
              if (A.postRun) for ("function" == typeof A.postRun && (A.postRun = [A.postRun]); A.postRun.length;) c = A.postRun.shift(), Qa.unshift(c);
              Ta(Qa)
            }
          }
        }
        ...
        a = a || ma;
        if (!(0 < Va)) if (G) ha(A), Sa(), postMessage({cmd: "loaded"});
        else {
          if (!G) {
            if (A.preRun) for ("function" == typeof A.preRun && (A.preRun = [A.preRun]); A.preRun.length;) Ua();
            Ta(Na)
          }
          0 < Va || (A.setStatus ? (A.setStatus("Running..."), setTimeout(function() {
            setTimeout(function() {
              A.setStatus("")
            }, 1);
            b()
      ...
      function ob(a) {
        Ca = a;
        if (G) throw postMessage({cmd: "exitProcess", returnCode: a}), new ua(a);
        va() || B.bc();
        Ca = a;
        if (!va()) {
          B.bc();
          if (A.onExit) A.onExit(a);
          Ba = !0
        }
        oa(a, new ua(a))
      }
